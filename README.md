...
```javascript
circularArrayStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-from-circular-array@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-from-circular-array@umd/bundle.js"></script>
```
