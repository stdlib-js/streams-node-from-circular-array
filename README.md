...
```javascript
import circularArrayStream from 'https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-from-circular-array@v0.2.1-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory, objectMode } from 'https://cdn.jsdelivr.net/gh/stdlib-js/streams-node-from-circular-array@v0.2.1-deno/mod.js';
```
